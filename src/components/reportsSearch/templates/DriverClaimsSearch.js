       ...
       let advanceIcon =( <InputAdornment position="end">
        ...
        return (
            ...
            <div className={styles.container}>
                ...
                <div className={styles.rateingContainer}>
                        <div style={{paddingTop:14}}>
                        <InputLabel style={{fontSize:18,fontWeight:"600",marginTop:0,color:"#000"}} shrink >{translate("BALANCE_FROM")}:</InputLabel>
                        </div>
                        <TextField
                        name="balance_from"
                        variant="standard"
                        onChange={this.changeTextHandler}
                        value={this.state.balance_from}
                        />           
                </div>
                <div className={styles.rateingContainer}>
                        <div style={{paddingTop:14}}>
                        <InputLabel style={{fontSize:18,fontWeight:"600",marginTop:0,color:"#000"}} shrink >{translate("BALANCE_TO")}:</InputLabel>
                        </div>
                        <TextField
                        name="balance_to"
                        variant="standard"
                        onChange={this.changeTextHandler}
                        value={this.state.balance_to}
                        />           
                </div>
