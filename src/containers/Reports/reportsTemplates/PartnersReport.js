...
export class DriverReport extends Component {
    ...
    _getConfigurations = async () => {
        ...
        axios
            ...
            .then(response => {
                this.setState({
                    partnersReportInterval: response.data.partners_report_time_interval
                });
            })
        ...
        return (
            <Grow in={true}>
                <div className={styles.reportWrapper}>
                    ...
                    <div severity='info'>
                        {translate("THE_DATA_IN_THIS_REPORT_ARE_FOR_THE_PAST")} {this.state.partnersReportInterval} {translate("MONTHS")}
                    </div>
